...
class SpatialQuantification:
    ...
    def print_quantification_group(self,
        acr: str,
        hemisphere: str,
        data_name: Union[str, None] = None,
        ...
        """
        Method for printing the quantification associated with a specific anatomical group.
    ...
    def print_quantification_per_set(self,
        ...
        """
        Method for printing the proportion of voxels per set in each anatomical group.
    ...
    def quantification_per_hemisphere(self, data_name: Union[str, None] = None):
