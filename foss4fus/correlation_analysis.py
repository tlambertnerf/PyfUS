...
class CorrelationAnalysis:
    ...
    def compute_corr_map(self,
        ...
        atlas_path: str = '../atlases/atlases_npy/atlas_ccf_v3_100_nolayersnoparts.npy',
        regions_info_path: str = '../atlases/atlases_lists/regions_ccf_v3_100_nolayersnoparts.txt'
        ):
        ...
        if plot:
            ...
            im = ax1.imshow(corr_map_2D, cmap='jet', vmin=-1, vmax=1)
